...
Conversation, maintenance, vision, embeddings, search, and image generation are separate paths. Optional services fail
back or remain disabled instead of silently changing the visible conversation model.
